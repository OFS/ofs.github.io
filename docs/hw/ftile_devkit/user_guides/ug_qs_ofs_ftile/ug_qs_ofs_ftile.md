...
The purpose of this document is to help users get started in evaluating the 2024.1-1 version of the PCIe Attach release targeting the F-Series Development Kit. This document will **not** cover [Board Installation Guidelines](https://ofs.github.io/ofs-2024.1-1/hw/common/board_installation/devkit_board_installation/devkit_board_installation_guidelines/) or [OFS Software Installation](/ofs-2024.1-1/hw/common/sw_installation/pcie_attach/sw_install_pcie_attach). Instead it will recommend you use a software installer to allow for fast evaluation. After reviewing this document, a user shall be able to:
...
| OFS FIM Common Resources| 2024.1-1| https://github.com/OFS/ofs-fim-common/releases/tag/ofs-2024.1-1 |
...
| OFS SW Installer | [OFS 2024.1-1 Release Page](https://github.com/OFS/ofs-agx7-pcie-attach/releases/tag/ofs-2024.1-1) |

#### Table 3: Hardware BKC for OFS PCIe Attach targeting the F-Series Development Kit

The following table highlights the hardware which composes the Best Known Configuration (BKC) for the OFS 2024.1-1 PCIe Attach release targeting F-Series Development Kit.
...
![F-tile-PCIe-Attach](/ofs-2024.1-1/hw/ftile_devkit/user_guides/ug_qs_ofs_ftile/images/F-tile-PCIe-Attach.png)
...
5. Open the Quartus programmer GUI
  ...
  ![quartus_pgmw](/ofs-2024.1-1/hw/ftile_devkit/dev_guides/fim_dev/images/quartus_pgmw.png)
...
1. Click **Hardware Setup** to open the Hardware Setup dialog window.
  ...
  2. In the **Hardware frequency** field enter `16000000` Hz
      ...
      ![quartus_pgmw_hardware_setup](/ofs-2024.1-1/hw/ftile_devkit/dev_guides/fim_dev/images/quartus_pgmw_hardware_setup.png)
...
3. If prompted, select the AGFB027R24C2E2VR2 device. The JTAG chain should show the device.
  ...
  ![quartus_pgmw_device_chain](/ofs-2024.1-1/hw/ftile_devkit/dev_guides/fim_dev/images/quartus_pgmw_device_chain.png)

9. Right click the AGFB027R24C2E2VR2 row and selct **Change File**.

  ![quartus_pgmw_change_file](/ofs-2024.1-1/hw/ftile_devkit/dev_guides/fim_dev/images/quartus_pgmw_change_file.png)
...
2.  Check the **Program/Configure** box for the AGFB027R24C2E2VR2 row, then click **Start**. Wait for the **Progress** bar to show `100% (Success)`.
  ...
  ![quartus_pgmw_success](/ofs-2024.1-1/hw/ftile_devkit/dev_guides/fim_dev/images/quartus_pgmw_success.png)
...
Download the OFS PCIe Attach installation script from the [OFS 2024.1-1 Release Page](https://github.com/OFS/ofs-agx7-pcie-attach/releases/tag/ofs-2024.1-1). Unpack the files:

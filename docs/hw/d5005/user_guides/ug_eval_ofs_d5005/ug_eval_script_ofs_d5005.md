...
| OFS FIM Source Code| [Branch: ofs-d5005](https://github.com/OFS/ofs-d5005), [Tag: release/ofs-2023.3](https://github.com/OFS/ofs-d5005/releases/tag/ofs-2023.3) | OFS Shell RTL for Intel Stratix 10 FPGA (targeting Intel® FPGA PAC D5005) |
...
1. You must create a directory named "ofs-X.X.X" where the X represents the current release number, for example ofs-2023.3. 
...
3. Once the repositories are cloned, copy the evaluation script (ofs_d5005_eval.sh) which is located at [eval_scripts] beneath the ofs-2023.3 directory location as shown in the example below:
...
In the example above we have used ofs-2023.3 as the directory name
...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 9 - Check ADP software versions for ADP Intel® FPGA PAC D5005 Project | OFS_ROOTDIR is set to /home/user_area/ofs-2023.3/ofs-d5005<br />OPAE_SDK_REPO_BRANCH is set to release/2.10.0-1 <br />OPAE_SDK_ROOT is set to /home/user_area/ofs-2023.3/ofs-d5005/../opae-sdk <br />LD_LIBRARY_PATH is set to /home/user_area/ofs-2023.3/ofs-d5005/../opae-sdk/lib64: |
...
| Menu Option                                                  | Result                                                       |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 57 - Build and Simulate Complete Intel® FPGA PAC D5005  Project | Generating Log File with date and timestamp Log file written to /home/user_area/ofs-2023.3/log_files/D5005_log_2022_11_10-093649/ofs-d5005_eval.log |

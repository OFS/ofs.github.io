...
This document does **not** cover first time setup of the Intel® IPU Platform F2000X-PL platform.

### 1.1 Audience

The information in this document is intended for customers evaluating an SoC Attach release. This document will cover key topics related to initial bring up of the Intel® IPU Platform F2000X-PL software stack, with links for deeper dives on the topics discussed therein.

...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/FIM_top_intro.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/AFU_Dev_Flow.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/N6000_Block.png)

The N6001 FIM provided with this release is shown below:

![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/N6000_Base_x16_BlockDia.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/OFS_DataFlow.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/pim_based_afu.png)
...
[PIM Based AFU Developer Guide](https://ofs.github.io/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_pim_based_afu/ug_dev_pim_based_afu/) provides details on interfacing your AFU to the FIM using the PIM. 
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/N6000_AFU_IF.png)
...
Working with the Intel® FPGA SmartNIC N6001-PL card requires **opae-2.12.0-5**. Follow the instructions in the Follow the instructions in the [Software Installation Guide: OFS for PCIe Attach FPGAs](https://ofs.github.io/ofs-2024.1-1/hw/common/sw_installation/pcie_attach/sw_install_pcie_attach) to build and install the required OPAE SDK for the Intel® FPGA SmartNIC N6001-PL. Make sure to check out the cloned repository to tag **2.12.0-5** and branch **release/2.12.0**.
...
Downlaod the FIM to the Intel® FPGA SmartNIC N6001-PL platform. If you are running on a Virtual Machine, refer to the [KVM User Guide: Open FPGA Stack](https://ofs.github.io/ofs-2024.1-1/hw/common/user_guides/ug_kvm/ug_kvm/) for passing the devices to the VM.
```sh
...
If you are running on a Virtual Machine, refer to the [KVM User Guide: Open FPGA Stack](https://ofs.github.io/ofs-2024.1-1/hw/common/user_guides/ug_kvm/ug_kvm/) for passing the devices to the VM.
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/usrclk_timing.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ASE_HighLevel.png)
...
The N6001 SKU2 card requires **2.12.0-5**. Follow the instructions provided in the Follow the instructions in the [Software Installation Guide: OFS for PCIe Attach FPGAs](https://ofs.github.io/ofs-2024.1-1/hw/common/sw_installation/pcie_attach/sw_install_pcie_attach) to build and install the required OPAE SDK for the Intel® FPGA SmartNIC N6001-PL. Make sure to check out the cloned repository to tag **2.12.0-5** and branch **release/2.12.0**.
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ASE_HW.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ASE_Run.png)
<br/><br/>
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ASE_VCS_hier_2023_2.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ASE_VCS_AFU_Waveforms_2023_2.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ASE_Run_hello_world.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ASE_VCS_hier_hello_world_2023_2.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ASE_VCS_AFU_Hello_World_Waveforms_2023_2.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/RSTP_local.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_proj_nav_2023_1.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_clock.png)

6. The Node Finder comes up and you will click `...` as shown below to bring up the hierarchy navigator:
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_clk_bringup_hier_nav.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_set_up_clk_2023_3.png)

9. Double click the ```Double-click to add nodes``` as shown below:
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_double_click.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_sig_select_2023_3.png)

11. Then click ```Insert``` and ```Close```.
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_final_setup_2023_3.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_save_stp_2023_3.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ST_HW_Select.png)

  JTAG over protocol selected:
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/ST_JTAG_Selected.png)
...
![](/ofs-2024.1-1/hw/common/user_guides/afu_dev/ug_dev_afu_ofs_agx7_pcie_attach/images/stp_data_2023_2.png)
...
For information on how to modify the PF/VF mapping for your own design, refer to the [Shell Developer Guide: OFS for Agilex® 7 PCIe Attach (P-tile, E-tile) FPGAs](https://ofs.github.io/ofs-2024.1-1/hw/n6001/dev_guides/fim_dev/ug_dev_fim_ofs_n6001/).

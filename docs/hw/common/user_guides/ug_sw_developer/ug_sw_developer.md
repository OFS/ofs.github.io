...
|-----|-----|-----|
|OPAE SDK| Intel® FPGA SmartNIC N6000-PL| 2.14.0-3|
|OPAE SDK| Intel® FPGA SmartNIC N6001-PL| 2.14.0-3|
|OPAE SDK| Agilex™ 7 FPGA F-Series Development Kit (2x F-Tile)| 2.14.0-3|
|OPAE SDK| Agilex™ 7 FPGA I-Series Development Kit (2x R-Tile and 1xF-Tile)| 2.14.0-3|
...
|Component|Platform|Most Recent Release|
|-----|-----|-----|
|Linux DFL| Intel® FPGA SmartNIC N6000-PL| intel-1.12.0-2|
|Linux DFL| Intel® FPGA SmartNIC N6001-PL| intel-1.12.0-2|
|Linux DFL| Agilex™ 7 FPGA F-Series Development Kit (2x F-Tile)| intel-1.12.0-2|
|Linux DFL| Agilex™ 7 FPGA I-Series Development Kit (2x R-Tile and 1xF-Tile)|intel-1.12.0-2 |

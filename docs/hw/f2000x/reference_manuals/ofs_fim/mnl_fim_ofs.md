...
The verification infrastructure can be found [here](https://github.com/OFS/ofs-f2000x-pl/verification) for evaluation and use. Please refer to the [Simulation User Guide]( https://ofs.github.io/ofs-2023.3/hw//f2000x/user_guides/ug_sim_ofs/ug_sim_ofs.md) for more information.
...
The OFS FIM is designed with configurability and scalability in mind.  At a high level, these are the necessary steps for a user to customize the design.  Please refer to the [FPGA Interface Manager Developer's Guide](https://ofs.github.io/ofs-2023.3/hw//f2000x/dev_guides/fim_dev/ug_dev_fim_ofs.md)

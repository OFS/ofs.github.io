...
This document serves as a set-up and user guide for the checkout and evaluation of an Intel IPU Platform F2000X-PL development platform using Open FPGA Stack (Intel OFS). After reviewing the document, you will be able to:
...
| OFS FIM Common| [Branch: ${{ env.F2000X_OFS_COMMON_REL_PATH }}](https://github.com/OFS/ofs-fim-common), [Tag: ${{ env.F2000X_OFS_COMMON_REL_PATH }}](https://github.com/OFS/ofs-fim-common/releases/tag/${{ env.F2000X_OFS_COMMON_REL_PATH }}) | Common RTL across all OFS-based platforms |
| AFU Examples| [Branch: examples-afu](https://github.com/OFS/examples-afu) , [Tag:ofs-examples-${{ env.F2000X_AFU_EX_REL_PATH }}](https://github.com/OFS/examples-afu/releases/tag/${{ env.F2000X_AFU_EX_REL_PATH }}) | Tutorials and simple examples for the Accelerator Functional Unit region (workload region)|
...
| Kernel Drivers | [Branch: ${{ env.F2000X_KERNEL_TAGF2000X_KERNEL_TAG }}](https://github.com/OFS/linux-dfl/tree/ofs-2023.1-5.15-1), [Tag: ofs-2023.1-5.15-1](https://github.com/OFS/linux-dfl/releases/tag/ofs-2023.1-5.15-1) | OFS specific kernel drivers|
...
A download page containing the release and already-compiled FIM binary artifacts that you can use for immediate evaluation on the ${{ env.F2000X }} can be found on the [OFS ${{ env.F2000X_OFS_TAG }}](https://github.com/OFS/ofs-f200x/releases/tag/${{ env.F2000X_OFS_TAG }}) official release drop on GitHub.
...
<img src="images/ofs_f2000x_tools_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_adp_tools_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_adp_hardware_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_adp_pf_vf_mux_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_adp_fim_pr_build_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_adp_hardware_programming_diagnostic_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_adp_harwdare_afu_testing_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_adp_harwdare_afu_bbb_testing_menu.png" alt="drawing" style="width:450px">
...
Builds, compiles  and runs standalone simulation block test, dfl_walker, developed by Intel.  For more unit test examples, refer to the UVM Simulation User Guide. 

<img src="images/ofs_f2000x_adp_unit_test_project_menu.png" alt="drawing" style="width:450px">
...
Builds, compiles and runs full chip simulation tests developed by Intel, Te user should execute the options sequenstially ie 41,42, 43 and 44

<img src="images/ofs_f2000x_adp_uvm_project_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_adp_build_all_project_menu.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_default_build.png" alt="drawing" style="width:450px">
...
<img src="images/ofs_f2000x_user_case1_build.png" alt="drawing" style="width:450px">
